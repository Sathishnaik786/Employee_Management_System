    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-950 text-white font-sans p-8 relative overflow-hidden">
      ...
      >
        ...
        <div className="space-y-8">
          ...
          <h1 className="text-7xl md:text-9xl font-display font-black tracking-tighter text-white uppercase leading-[0.85]">Lost in <br /><span className="text-teal-500 text-gradient-teal">YVI People.</span></h1>
        ...
        <div className="pt-20 flex flex-col items-center gap-6 opacity-40">
          ...
          <p className="text-[10px] font-bold text-slate-600 uppercase tracking-widest">YVI Enterprise Management Systems © 2026</p>
        </div>
      </motion.div>
    </div>
  );
