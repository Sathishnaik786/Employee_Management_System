        ...
        <AnimatedContainer direction="up" delay={0.6}>
          <div className="text-center">
            <GlassCard className="p-16 border-2 border-orange-500/20">
              ...
              <p className="text-slate-500 dark:text-slate-400 mb-8 max-w-2xl mx-auto">Connect with our team to learn how YVI People transforms enterprise operations.</p>
